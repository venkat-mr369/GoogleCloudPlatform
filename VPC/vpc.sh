...
gcloud compute networks subnets create subnet-a  --network=my-vpc-network --range=10.0.1.0/24 --region=asia-southeast1
gcloud compute networks subnets create subnet-b  --network=my-vpc-network --range=10.0.2.0/24 --region=asia-southeast1
